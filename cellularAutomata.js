...
replayButton === null || replayButton === void 0 ? void 0 : replayButton.addEventListener('click', () => {
    startGame();
});
...
const fillGameField = () => {
    ...
    for (let i = 0; i < field.length; i++) {
        for (let j = 0; j < field.length; j++) {
            ...
            gameField === null || gameField === void 0 ? void 0 : gameField.appendChild(divElement);
        }
    }
};
fillGameField();
...
const processGame = (widthIndex, heightIndex) => {
...
const getDiagonalValue = (widthIndex, heightIndex, diagonalPosition) => {
...
const isIndexValueValid = (widthIndex, heightIndex) => {
...
const setValue = (widthIndex, heightIndex, diagonalValueCount) => {
